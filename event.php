    ...
    function doModel() {
        switch($this->action) {
            /*case('contact_post'):   //contact_post
                ...
                if($subject == '') {
                    osc_add_flash_error_message( _m('Subject Required.') ) ;
                ...
                if($message == '') {
                    osc_add_flash_error_message( _m('Message Required.') ) ;
                    Session::newInstance()->_setForm("yourName",$yourName);
                    Session::newInstance()->_setForm("yourEmail",$yourEmail);
                    Session::newInstance()->_setForm("subject",$subject);
                    Session::newInstance()->_setForm("message_body",$message);
                ...
                if($yourName == '') {
                    osc_add_flash_error_message( _m('Name Required.') ) ;
                    Session::newInstance()->_setForm("yourName",$yourName);
                    Session::newInstance()->_setForm("yourEmail",$yourEmail);
                    Session::newInstance()->_setForm("subject",$subject);
                    Session::newInstance()->_setForm("message_body",$message);
                ...
                if($yourEmail == '') {
                    osc_add_flash_error_message( _m('Email Required.') ) ;
                    Session::newInstance()->_setForm("yourName",$yourName);
                    Session::newInstance()->_setForm("yourEmail",$yourEmail);
                    Session::newInstance()->_setForm("subject",$subject);
                    Session::newInstance()->_setForm("message_body",$message);
                ...
                if ((osc_recaptcha_private_key() != '') && Params::existParam("recaptcha_challenge_field")) {
                    if(!osc_check_recaptcha()) {
                        osc_add_flash_error_message( _m('Invalid Code.')) ;
                        Session::newInstance()->_setForm("yourName",$yourName);
                        Session::newInstance()->_setForm("yourEmail",$yourEmail);
                        Session::newInstance()->_setForm("subject",$subject);
                        Session::newInstance()->_setForm("message_body",$message);
                ...
                if( !preg_match('|.*?@.{2,}\..{2,}|',$yourEmail) ) {
                    osc_add_flash_error_message( _m('Invalid Email.') ) ;
                    Session::newInstance()->_setForm("yourName",$yourName);
                    Session::newInstance()->_setForm("subject",$subject);
                    Session::newInstance()->_setForm("message_body",$message);
                    $this->redirectTo(osc_contact_url());
