<?php
    ...
    switch( Params::getParam('page') )
    {
        ...
        break;
        case ('shop'):   //shops
                            require_once(osc_base_path() . 'shop.php') ;
                            $do = new CWebContact() ;
                            $do->doModel() ;
        break;
        case ('hnr'):   //hotels n restaurants
                            require_once(osc_base_path() . 'hnr.php') ;
                            $do = new CWebContact() ;
                            $do->doModel() ;
        break;
        case ('event'):   //hotels n restaurants
                            require_once(osc_base_path() . 'event.php') ;
                            $do = new CWebContact() ;
                            $do->doModel() ;
        break;
        case ('custom'):   //contact
