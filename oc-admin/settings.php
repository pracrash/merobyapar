...
HTACCESS;
											...
											//added by shakeelstha on 20 July 2012 for watchlist url rewrite
											/*$rewrite_watchlist = substr(str_replace('//', '/', Params::getParam('rewrite_watchlist').'/'), 0, -1);
                                            if(!osc_validate_text($rewrite_watchlist)) {
                                                $errors += 1;
                                            } else {
                                                Preference::newInstance()->update(array('s_value' => $rewrite_watchlist)
                                                                                 ,array('s_name' => 'rewrite_watchlist'));
                                            } */
											...
											// Watchlist rule
											//$rewrite->addRule('^'.osc_get_preference('rewrite_watchlist').'/?$', 'index.php?page=custom&file=watchlist/watchlist.php');
