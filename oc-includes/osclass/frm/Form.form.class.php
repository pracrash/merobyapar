<?php if ( ! defined('ABS_PATH')) exit('ABS_PATH is not loaded. Direct access is not allowed.');
    ...
    class Form {
        static protected function generic_select($name, $items, $fld_key, $fld_name, $default_item, $id) {
            echo '<select name="' . $name . '" id="' . $name . '" style="width: auto;" class="chzn-select">' ;
        ...
        static protected function generic_textarea($name, $value) {
            echo '<textarea id="' . $name . '" name="' . $name . '" rows="10" class="mceEditor o2k7Skin o2k7SkinSilver">' . $value . '</textarea>' ;
        }
