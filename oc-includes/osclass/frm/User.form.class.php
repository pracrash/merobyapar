        ...
        static public function multilanguage_info($locales, $user = null) {
            ...
            foreach($locales as $locale) {
                if($num_locales>1) { echo '<div class="tabbertab">'; };
                    ...
                    self::info_textarea('description', $locale['pk_c_code'], $info);
...
//                echo '<span>' .$cities[0]['s_name'] . '</span>';
        ...
        static public function youtube_area_text($user = null) {
            parent::generic_input_text('youTube', (isset($user['s_youtube'])) ? $user['s_youtube'] : null) ;
        }
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		s_name: {
                ...
                termsncondition: {
                        required: "<?php _e("Accept terms and condition"); ?>."
                }
            },
