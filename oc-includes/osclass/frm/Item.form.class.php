<?php if ( ! defined('ABS_PATH')) exit('ABS_PATH is not loaded. Direct access is not allowed.');
    ...
    class ItemForm extends Form {
        ...
        static public function category_select($categories = null, $item = null, $default_item = null, $parent_selectable = false)
        {
            ...
            echo '<select name="catId" id="catId" style="width: auto;" class="chzn-select">' ;
        ...
        static public function multilanguage_title_description($locales = null, $item = null) {
            ...
            foreach($locales as $locale) {
                ...
                echo '<div class="title" style="margin-top: 15px;">';
            ...
            if($resources!=null && is_array($resources) && count($resources)>0) {
                foreach($resources as $_r) { ?>
                    <div id="<?php echo $_r['pk_i_id'];?>" fkid="<?php echo $_r['fk_i_item_id'];?>" name="<?php echo $_r['s_name'];?>">
                        <img src="<?php echo osc_apply_filter('resource_path', osc_base_url() . $_r['s_path']) . $_r['pk_i_id'] . '_thumbnail.' . $_r['s_extension']; ?>" onclick="javascript:delete_image(<?php echo $_r['pk_i_id'].", ".$_r['fk_i_item_id'].", '".$_r['s_name']."', '".Params::getParam('secret')."'" ;?>);" width="100" height="100" />
                        <!--<a href="javascript:delete_image(<?php echo $_r['pk_i_id'].", ".$_r['fk_i_item_id'].", '".$_r['s_name']."', '".Params::getParam('secret')."'" ;?>);"  class="icon-delete"><?php _e('Delete'); ?></a>-->
                    </div>
                <?php }
            }
        }
