<?php
    ...
    function osc_private_user_menu($options = null)
    {
	    ...
	    $options[] = array('name' => __('My Profile'), 'url' => osc_user_profile_url(), 'class' => 'opt_account') ;
            $options[] = array('name' => __('Manage Listings'), 'url' => osc_user_list_items_url(), 'class' => 'opt_items') ;
            //$options[] = array('name' => __('Manage Alerts'), 'url' => osc_user_alerts_url(), 'class' => 'opt_alerts') ;
			//$options[] = array('name' => __('Manage Comments'), 'url' => osc_user_comments_url(), 'class' => 'opt_comments') ;
            $options[] = array('name' => __('Change Password'), 'url' => osc_change_user_password_url(), 'class' => 'opt_change_password') ;
        ...
        echo '<ul class="user_menu">' ;
            ...
            for($var_o = 0 ; $var_o < ($var_l-1) ; $var_o++) {
                echo '<li class="' . $options[$var_o]['class'] . '" ><a href="' . $options[$var_o]['url'] . '" ><i class="icon-user"></i> ' . $options[$var_o]['name'] . '</a></li>' ;
            }

            osc_run_hook('user_menu') ;
            
            echo '<li class="' . $options[$var_l-1]['class'] . '" ><a href="' . $options[$var_l-1]['url'] . '" ><i class="icon-user"></i> ' . $options[$var_l-1]['name'] . '</a></li>' ;
