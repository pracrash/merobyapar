<?php
    ...
    */
     ...
     * @return string
     */
    function osc_item_url($locale = '', $item_id='') {
        if ( osc_rewrite_enabled() ) {
            ...
            $path = ($item_id != '') ? osc_item_url_ns($item_id, $locale) : osc_item_url_ns(osc_item_id(), $locale);
        }
        return $path ;
    }
	...
	/**
     * Gets url of watchlist
     *
     * @return string
     */
    /*function osc_watchlist_url() {
        if ( osc_rewrite_enabled() ) {
            return osc_base_url() . osc_get_preference('rewrite_watchlist');
        } else {
            return osc_base_url(true)."?page=custom&file=watchlist/watchlist.php";
        }
    } */
    /////////////////////////////////////
