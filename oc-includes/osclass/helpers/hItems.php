<?php
    ...
    */
	...
	/************added by shakeelstha on 31 july 2012 for trimmed description******************/
    ...
    function osc_item_is_premium() {
	    ...
	    /**
     * Gets false if current item is not marked premium, else return true
     *
     * @return boolean
     */
    function osc_item_is_not_premium() {
        if ( osc_item_field("b_premium") ) return false ;
        else return true ;
    }
	
	/**
     * Gets true if current item is marked premium for scroller, else return false
     *
     * @return boolean
     */
    function osc_item_is_premium_scroller() {
        if ( osc_item_field("b_premium_scroller") ) return true ;
        else return false ;
    }
