...
<div>
    <ul class="breadcrumb">
        ...
        <li class="last-child" >Watchlist</li>
    </ul>
    <div class="clear"></div>
</div>
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo $class; ?>">
                                ...
                                <td class="text">
                                    ...
                                    <p align="right"><a class="icon-delete" onclick="javascript:return confirm('<?php _e('This action can not be undone. Are you sure you want to continue?', 'watchlist'); ?>')" href="<?php echo osc_render_file_url(osc_plugin_folder(__FILE__) . 'watchlist.php') . '?delete=' . osc_item_id(); ?>" ><?php _e('&nbsp;', 'watchlist'); ?></a><p>
                                </td>
                            </tr>
