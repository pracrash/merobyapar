<?php
/*
Plugin Name: Carousel for Item slide
...
// for example you might want to create a table or modify some values
    ...
    try {
        ...
        osc_set_preference('carousel_autoscroll'   , '0', 'plugin-carousel_for_osclass', 'INTEGER');
        ...
        osc_set_preference('carousel_premiumScrollerOnly'  , '0','plugin-carousel_for_osclass','INTEGER');
	     /* 2.0 preferences */
...
function osc_carousel_premiumScrollerOnly() {
    return(osc_get_preference('carousel_premiumScrollerOnly', 'plugin-carousel_for_osclass')) ;
}
...
// Self-explanatory
function carousel($itemPage = FALSE, $itemLimit = 20) {
    $items = (osc_carousel_items() != '') ? osc_carousel_items() : '' ;
    $premOnly = (osc_carousel_premiumScrollerOnly() != '') ? osc_carousel_premiumScrollerOnly() : '' ;    
