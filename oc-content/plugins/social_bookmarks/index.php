...
*/
    ...
    function social_bookmarks($content) {
        ...
        // facebook
        $content .= '<li class="facebook"><div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="" send="true" layout="button_count" show_faces="false" font=""></fb:like></li>' ;
        // google plus
