...
tabClose:false,
easing:'easeOutQuint',
buttons:'twitter,facebook,plusone,buzz,digg,stumbleupon'};
...
$floater.css({
width:defaults.width+'px',position:cssPos,zIndex:10000
});
