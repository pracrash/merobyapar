...
*/
    ...
    //$buysell_types['NEWSELL'] = __('New Sell', 'buysell');
    //$buysell_types['BUY']  = __('Buy', 'buysell');
	///$buysell_types['SECONDHANDSELL']  = __('Second Hand Sell', 'buysell');
	$buysell_types['NORMAL']  = __('Normal', 'buysell');
	$buysell_types['SPECIALOFFER']  = __('Special Offer', 'buysell');
	$buysell_types['LIMITEDOFFER']  = __('Limited Offer', 'buysell');
	$buysell_types['FESTIVALOFFER']  = __('Festival Offer', 'buysell');
