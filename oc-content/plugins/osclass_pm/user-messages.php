...
<div class="silver_box_lite">
    <div class="wh_curve_box user_account">
        <h1><?php echo __('Message: ', 'osclass_pm') . osc_highlight($pm['pm_subject'], 50); ?></h1>
    ...
    <div id="main">
	  ...
	  <?php if(Params::getParam('box') == 'inbox') { ?>
         <a href="<?php echo osc_base_url(true) . '?page=custom&file=osclass_pm/user-inbox.php'; ?>" class="backtoInbox">Back to inbox</a>
      <?php } elseif(Params::getParam('box') == 'outbox') { ?>
         <a href="<?php echo osc_base_url(true) . '?page=custom&file=osclass_pm/user-outbox.php'; ?>" class="backtoInbox">Back to outbox</a>
      <?php } ?> 
      <br />
      <br />
      <div class="pm_main">
