...
<div class="content user_account">
    ...
    <div id="main">
			...
			<div id="form_publish">
				...
				<a href="<?php echo osc_base_url(true) . '?page=custom&file=osclass_pm/user-send.php&userId=0&mType=new';?>"><?php echo __('Send PM to the','osclass_pm') . ' ' . pmAdmin(); ?></a>
				</strong>
			</div>
			<br/><br/>
            ...
            <div class="dataTables_wrapper">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="datatables_pm">
                 	<thead>
                   <tr>
                     <th width="2%"><input name="checkAll" id="checkAll" type="checkbox" /></th>
                   	<th width="22%"><?php _e('Date','osclass_pm'); ?></th>
                   	<th width="50%"><?php _e('Subject','osclass_pm'); ?></th>
                   	<th width="25%"><?php _e('From','osclass_pm'); ?></th>
                   </tr>
                  </thead>
                  <tbody>
                  <?php if($recipCount == 0) { ?>
