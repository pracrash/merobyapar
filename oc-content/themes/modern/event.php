            ...
            <section id="container">
                <div class="silver_box_lite">
                    <div class="wh_curve_box">
                        <h1><?php _e('Event List', 'modern') ; ?></h1>
                        <div class='alpha_container'>
                            <?php list_event(); ?>
                            <?php 
                                $eventsCompanyList = list_event();
                                foreach($eventsCompanyList as $eventsCompany) {
                                    echo '<a href="'.osc_base_url(TRUE).'?page=user&action=pub_profile&id='.$eventsCompany['pk_i_id'].'">'.$eventsCompany['s_name'].'</a><br /><br />';
                                }
