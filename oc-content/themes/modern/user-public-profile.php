...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
	...
	<?php //jquery_social_share(); ?>
        ...
        <div class="silver_box_lite">
            <div class="wh_curve_box item user_public_profile">
            <h1><?php echo sprintf(__('%s\'s profile', 'modern'), osc_user_name()); ?></h1>
            <div id="main" style="padding:0 15px;">
                <br />
                <div id="description">
                <!--h2><?php _e('Profile', 'modern'); ?></h2-->
                                    <div style="float:left; width:170px;"><?php get_profile_pic($_GET['id']);?></div>
                    <ul id="user_data" style="margin:0 0 0 170px; padding:0">
						...
						<?php voting_item_detail_user( osc_user_id() ); ?>
                    </ul>
                </div>
            ...
            <div id="sidebar">
                ...
                <style type="text/css">
					...
					.item #sidebar{ float:none; width:auto; clear: both}
