...
<div class="silver_box_lite">
    <div class="wh_curve_box">
        ...
        <div id="sidebar">
            ...
            <div id="main">
                <h2><?php _e('Your listings', 'modern'); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo osc_item_post_url() ; ?>" class="btn_org">+ <?php _e('Post a new listing', 'modern'); ?></a></h2>
			...
			<?php if( osc_images_enabled_at_items() ) { ?>
                        ...
                        <?php } ?>
                            ...
                            <p class="options">
                                <strong><a href="<?php echo osc_item_edit_url(); ?>"><img src="<?php echo osc_current_web_theme_url('images/icons/edit.png') ; ?>" style="float:none; position:relative; top:5px;" /><?php //_e('Edit', 'modern'); ?></a></strong>
                                <span>|</span>
                                <a class="delete" onclick="javascript:return confirm('<?php echo osc_esc_js(__('This action can not be undone. Are you sure you want to continue?', 'modern')); ?>')" href="<?php echo osc_item_delete_url();?>" ><img src="<?php echo osc_current_web_theme_url('images/icons/delete.png') ; ?>"  style="float:none; position:relative; top:5px;"/><?php //_e('Delete', 'modern'); ?></a>
